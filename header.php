                    ...
                    <header id="kratos-header-section"<?php if(kratos_option('head_mode')!='pic') echo ' class="color-banner" style="background:rgba('.kratos_option('banner_color').')"'; ?>>
                        <div class="container">
                            <div class="nav-header">
                                ...
                                ?>
                                <!-- 暂时性修复 2021/02/16 -->
                                <nav id="kratos-menu-wrap" class="menu-%e9%bb%98%e8%ae%a4%e8%8f%9c%e5%8d%95-container"><ul id="kratos-primary-menu" class="sf-menu"><li class="current-menu-item"><a href="http://blog.moeworld.tech" aria-current="page" one-link-mark="yes"><i class="fa fa-home"></i> 首页</a></li>
